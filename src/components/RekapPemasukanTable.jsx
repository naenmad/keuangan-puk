        ...
        <table className="w-full text-left border-collapse text-xs sm:text-sm">
          <thead>
            <tr className="border-b-2 border-slate-300 dark:border-slate-800 bg-slate-100 dark:bg-surface/80 text-slate-700 dark:text-slate-300 font-bold uppercase text-[11px] tracking-wider">
              ...
              <th className="py-4 px-4 text-right font-bold text-blue-700 dark:text-accentCyan font-mono">
                Total Pemasukan (Rp)
              </th>
            </tr>
          </thead>
          <tbody className="divide-y divide-slate-200 dark:divide-slate-800/60 font-mono font-medium">
            {MONTH_NAMES.map((mName, idx) => {
              ...
              return (
                <tr key={mName} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                  ...
                  <td className="py-3.5 px-4 font-sans font-bold text-slate-900 dark:text-slate-200">{mName}</td>
                  {years.map(yr => {
            ...
            <tr className="bg-slate-100 dark:bg-slate-900 border-t-2 border-slate-400 dark:border-slate-700 font-bold text-sm">
              ...
              {years.map(yr => (
                <td key={yr} className="py-4 px-4 text-right text-emerald-700 dark:text-emerald-400 font-black font-mono">
